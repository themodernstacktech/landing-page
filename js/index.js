...
//=========================================================================================== light
var spotLight = new THREE.SpotLight(new THREE.Color("white"), 0.15);
spotLight.position.set(5, 100, 0);
spotLight.castShadow = true;
scene.add(spotLight);

var sphereLight = new THREE.SphereGeometry(0.05);
...
var pointLight3 = new THREE.PointLight(
...
function moveCharacter() {
  characterGroup.position.z < -75
    ? (characterGroup.position.z = 75)
    : (characterGroup.position.z -= 0.5);
}
